...
class _DetailPageState extends State<DetailPage> {
  // 一个请求例子(http://127.0.0.1:8000/detail/edu/ee5299b03326c1f816031f912dae31d7)
  final baseUrl = "http://127.0.0.1:8000/detail/";
  final historyUrl = "http://127.0.0.1:8000/history/";
  ...
  checkLogin()async{
    ...
    if(_username !="" && _isLogin == true ){
       String _url = "http://127.0.0.1:8000/checksave/" + username + "/" + widget.news_id;
  ...
  addSave() async{
    ...
    if(username =="" || isLogin == null || isLogin == false){
      showToast("请先登录");
        ...
        String _url = "http://127.0.0.1:8000/save/" + username + "/" + channelNameToEng[widget.news_channel] + "/" + widget.news_id;
